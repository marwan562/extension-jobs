...
import { FixtureJobSource, ComposioLinkedInSource, WuzzufJobSource, IndeedJobSource, MultiJobSource, type JobSource } from '../../../packages/site-adapters/src/index.ts';
...
if (env.JOB_SOURCE_MODE === 'development' || !env.JOB_SOURCE_MODE) {
  ...
  if (modes.includes('wuzzuf') || modes.includes('multi')) sources.push(new WuzzufJobSource());
