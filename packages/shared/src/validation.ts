...
const transitions: Partial<Record<ApplicationState, readonly ApplicationState[]>> = {
  ...
  WAITING_FOR_APPROVAL: ['FILLING', 'REJECTED_BY_USER', 'FORM_CHANGED', 'CANCELLED'], FILLING: ['VALIDATING', 'FORM_CHANGED', 'FAILED_RETRYABLE', 'CANCELLED'],
  VALIDATING: ['READY_TO_SUBMIT', 'FORM_CHANGED', 'FAILED_RETRYABLE', 'FAILED_PERMANENT', 'CANCELLED'], READY_TO_SUBMIT: ['SUBMITTING', 'FORM_CHANGED', 'CANCELLED'],
